...
angular.module('your_app_name', [
  ...
  .config(function ($ionicConfigProvider, $authProvider, config) {
    ...
    if (ionic.Platform.isIOS() || ionic.Platform.isAndroid()) {
      commonConfig.redirectUri = config.baseUrl;
    }
    ...
    $authProvider.facebook(angular.extend({}, commonConfig, {
      clientId: '1904558323195166',
      url: config.apiUrl + 'api/auth/facebook/callback'
    }));

  })

  .run(function ($ionicPlatform, $rootScope, $ionicHistory, $timeout, $ionicConfig, $state, AuthService) {
